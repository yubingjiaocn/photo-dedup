...
# Setup/finalize helpers live in :mod:`src.stage1_setup`; the alias keeps the
# original private name working for existing callers and tests.
_build_thumbnailer = stage1_setup.build_thumbnailer
